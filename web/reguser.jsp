    ...
    <body> 
        ...
        <section class="py-5">
            ...
            <ul class="pagination justify-content-center" style="margin:10px 0">
                <li class="page-item"><a class="page-link" href="ProductServlet.do?page=1">Previous</a></li>
                <li class="page-item"><a class="page-link" href="ProductServlet.do?page=1">1</a></li>
                <li class="page-item"><a class="page-link" href="ProductServlet.do?page=2">2</a></li>
                <li class="page-item"><a class="page-link" href="ProductServlet.do?page=3">3</a></li>
                <li class="page-item"><a class="page-link" href="ProductServlet.do?page=2">Next</a></li>
              </ul>
        </section>
