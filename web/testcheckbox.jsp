    ...
    <body>
        ...
        <form ACTION="">
            <table>
                <tr>
                    <td>Book 1</td>
                    <td><input type="checkbox" name="id" value="120">P 120.00</td>
                </tr>
                <tr>
                    <td>Book 2</td>
                    <td><input type="checkbox" name="id" value="150">P 150.00</td>
                </tr>
                <tr>
                    <td>Book 3</td>
                    <td><input type="checkbox" name="id" value="210">P 210.00</td>
                </tr>
                <tr>
                    <td>Book 4</td>
                    <td><input type="checkbox" name="id" value="130">P 130.00</td>
                </tr>
                <tr>
                    <td>Book 5</td>
                    <td><input type="checkbox" name="id" value="180">P 180.00</td>
                </tr>
            </table>            
