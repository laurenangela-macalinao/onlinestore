...
public class ReportSalesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String relativeWebPath = "WEB-INF/web.xml";
        ...
        if(reportType.equals("sales")) {
            ...
            reportName = reportObj.createInventoryReport(basePath);
        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ReportSalesServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<p>Report : <a href=\"" + reportName + "\">reportName</a>.</p>");
            out.println("</body>");
            out.println("</html>");
        }
    }
